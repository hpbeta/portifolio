    ...
    <Container id="projects">
      ...
      <ContainerProject>
        ...
        <div>
          ...
          <p>
            Nesse projeto, desenvolvo uma aplicação que consome a API do ViaCEP,
            onde o usuário insere um CEP e a aplicação retorna automaticamente o
            endereço completo, incluindo rua, bairro, cidade e estado. Isso
            facilita o preenchimento de formulários e garante a precisão dos
            dados postais.
          </p>
          <ContainerList>
            <li>
      ...
      <ContainerProject>
        ...
        <div>
          ...
          <p>
            ...
            informações, como nome, e-mail e mensagem. Ao enviar o formulário, o
            JavaScript verifica se todos os campos obrigatórios estão
      ...
      <ContainerProject>
       ...
       <div>
          ...
          <p>
            ...
            para exibir informações sobre repositórios e usuários. O usuário
            pode buscar por um nome de usuário e visualizar detalhes, como
            repositórios públicos e informações do perfil.
          </p>
          <ContainerList>
            <li>
              <FaHtml5 />
